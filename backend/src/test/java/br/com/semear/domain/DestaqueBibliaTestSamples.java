...
public class DestaqueBibliaTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static DestaqueBiblia getDestaqueBibliaSample1() {
    ...
    public static DestaqueBiblia getDestaqueBibliaSample2() {
        return new DestaqueBiblia()
            .id(2L)
    ...
    public static DestaqueBiblia getDestaqueBibliaRandomSampleGenerator() {
        return new DestaqueBiblia()
