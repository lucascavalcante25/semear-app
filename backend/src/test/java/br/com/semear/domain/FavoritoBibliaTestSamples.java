...
public class FavoritoBibliaTestSamples {

    private static final Random random = new Random();
    private static final AtomicLong longCount = new AtomicLong(random.nextInt() + (2 * Integer.MAX_VALUE));
    private static final AtomicInteger intCount = new AtomicInteger(random.nextInt() + (2 * Short.MAX_VALUE));

    public static FavoritoBiblia getFavoritoBibliaSample1() {
    ...
    public static FavoritoBiblia getFavoritoBibliaSample2() {
        return new FavoritoBiblia()
            .id(2L)
    ...
    public static FavoritoBiblia getFavoritoBibliaRandomSampleGenerator() {
        return new FavoritoBiblia()
