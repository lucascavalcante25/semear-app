...
public class Endereco implements Serializable {
    ...
    public void setPreCadastro(PreCadastro preCadastro) {
        if (this.preCadastro != null) {
            this.preCadastro.setEndereco(null);
        }
        if (preCadastro != null) {
            preCadastro.setEndereco(this);
        }
        this.preCadastro = preCadastro;
    }

    public Endereco preCadastro(PreCadastro preCadastro) {
        this.setPreCadastro(preCadastro);
        return this;
    }
