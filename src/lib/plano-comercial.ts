...
export const RECURSOS_PLANO_LANCAMENTO = [
  "Membros ilimitados",
  "Visitantes, funil de integração e pré-cadastros",
  "Departamentos com líderes e orientações",
  "Escalas de portaria, recepção e limpeza",
  "Sorteio automático por ciclo com rascunho e publicação",
  "Pedidos de oração e informativos com confirmação de leitura",
  "Avisos e notificações push no celular",
  "Eventos com inscrições, lembretes e relatório de inscritos",
  "Divulgação de eventos no WhatsApp e Instagram",
  "Agenda de cultos com pregador, mensagem e louvores",
  "Louvores e grupos de louvor com letra e cifra",
  "Devocionais",
  "Bíblia com plano de leitura coletivo",
  "Financeiro da igreja",
  "Documentos da igreja com controle de validade",
